...
class UserActions {
    ...
    private function encode() {
        if ( ! $this->credentialsArray ) {
            throw new AuthenticationException( "Giriş bilgilerini kontrol edin." );
        }

        return "data=" . base64_encode( json_encode( $this->credentialsArray ,JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) );
    }
    ...
    private function checkJSON( $base64Decoded, $column = null ) {
        ...
        $decoded = json_decode( $base64Decoded, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES );
